    ...
    <el-container class="home-container">
        ...
        <el-container>
            ...
            <el-aside :width="isCollapse ? '64px' : '200px'"> <!--侧边栏展开为200px 折叠时为64px-->
                ...
                <!-- 侧边栏菜单 -->
                <el-menu background-color="#444444" text-color="#fff" active-text-color="#e37554"
...
export default {
  ...
  methods: {
    ...
    async getMenuList() {
      ...
      if (res.meta.status !== 200) return this.$message.error(res.meta.msg) // 获取失败弹出消息框
